...
- **`/gsd:ralph [--phase N] [--regenerate]`** — Generate a Ralph loop harness: external fresh-context loop that grinds through phase plans unattended, one task per iteration.
